...
## 📚 Tech Stack
- **Language:** Java 21
- **Frameworks:** Spring Boot 4.1, Spring Data JPA, Spring Security, JUnit
...
Make sure that you register an account from the Authentication endpoint, then copy the accessToken string in the response body, then login to that account by pasting the token into the green Authorize button.
